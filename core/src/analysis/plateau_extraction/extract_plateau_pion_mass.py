...
def main(
    ...
    This script processes Pion mass jackknife samples, detects plateau
    ...
    try:
        ...
        if not results:
            ...
            logger.log_script_end("Pion mass plateau extraction failed (no groups)")
        ...
        if n_success == 0:
            ...
            logger.log_script_end(
                f"Pion mass plateau extraction skipped (no plateaus found in {n_total} groups)"
            )
