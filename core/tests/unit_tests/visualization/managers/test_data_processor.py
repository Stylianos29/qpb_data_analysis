...
This module provides comprehensive testing for the PlotDataProcessor class,
covering data validation, filtering, transformation, and preparation operations.
"""
...
class TestDataFiltering:
    ...
    def test_filter_valid_data_scalar(self, processor):
        ...
        # Note: np.inf is NOT filtered out for x values in the original code
    ...
    def test_filter_valid_data_tuples(self, processor):
        ...
        assert x_filtered[0] == (1, 0.1)
        assert x_filtered[1] == (3, 0.3)
...
class TestDataGrouping:
    ...
    def test_group_data_by_variable_preserve_order(self, processor):
        ...
        groups = processor.group_data_by_variable(
            df,
            'group',
            sort_ascending=None  # Preserve order
        )
