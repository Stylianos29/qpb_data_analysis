...
CONVERTERS_MAPPING = {
    ...
    "Average_sign_squared_violation_values": lambda x: ast.literal_eval(x) if x.strip() else x,
    "Average_ginsparg_wilson_relation_values": lambda x: ast.literal_eval(x) if x.strip() else x,
