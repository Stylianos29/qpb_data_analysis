...
AXES_LABELS_DICTIONARY = {
    ...
    "Average_number_of_CG_iterations_per_spinor": "Average # of CG iterations (per spinor)",
...
AXES_LABELS_BY_COLUMN_NAME = {
    ...
    "Jackknife_average_of_g5_g5_correlator_mean_values": "$C_{\\gamma_5\\text{-}\\gamma_5}$(t)",
    "Jackknife_average_of_g4g5_g5_correlator": "$C_{\\gamma_4\\gamma_5\\text{-}\\gamma_5}$(t)",
